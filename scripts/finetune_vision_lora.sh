...
OUTPUT_NAME=${OUTPUT_NAME:-"vision_lora_v1"}
EPOCHS=${EPOCHS:-1}
BATCH_SIZE=${BATCH_SIZE:-4}
LLM_LORA_RANK=${LLM_LORA_RANK:-16}
...
echo "=== Elbiat Vision + LLM LoRA Finetuning ==="
echo "Base model: ${BASE_MODEL}"
echo "Train data: ${TRAIN_DATA}"
echo "Output: ${OUTPUT_DIR}"
echo "LLM LoRA rank: ${LLM_LORA_RANK}"
echo "Vision LoRA rank: ${VISION_LORA_RANK}"
...
echo "=== Vision + LLM LoRA finetuning complete ==="
